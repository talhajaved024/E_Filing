...
const GridDemo = React.lazy(() => import('./views/demo/DemoGrid'))
const GridCharts = React.lazy(() => import('./views/demo/DashboardCharts'))
// Base
...
const FontAwesomeIcons = React.lazy(() => import('./views/icons/fontAwesomeIcons/FontAwesomeGrid'))
