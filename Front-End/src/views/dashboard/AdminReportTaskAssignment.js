...
const API_URL = 'http://13.219.180.255:8080/api/task-summary';
...
class AdminReportTaskAssignment extends Component {
  constructor(props) {
    super(props);
      ...
      <CCard>
        <CCardHeader>
          <div style={{ 
            ...
            <h5 style={{ margin: 0 }}>Tasks Detail</h5>
            <div style={{ 
              display: 'flex', 
              alignItems: 'center', 
              gap: '10px',
...
export default AdminReportTaskAssignment;