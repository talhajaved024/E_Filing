...
interface ProgressGroupExample1 {
  title: string;
  value1: number;
  value2: number;
}

interface ProgressGroupExample2 {
  title: string;
  icon: any;
  value: number;
}

interface ProgressGroupExample3 {
  title: string;
  icon: any;
  percent: number;
  value: string;
        ...
        <CCardFooter>
          <CRow xs={{ cols: 1 }} md={{ cols: 5 }} className="text-center">
            {progressExample.map((item, index) => (
              <CCol className="mb-sm-2 mb-0" key={index.toString()}>
              ...
              <CRow>
                <CCol xs={12} md={6} xl={6}>
                  ...
                  {progressGroupExample1.map((item, index) => (
                    <div className="progress-group mb-4" key={index.toString()}>
                ...
                <CCol xs={12} md={6} xl={6}>
                  ...
                  {progressGroupExample3.map((item, index) => (
                    <div className="progress-group" key={index.toString()}>
                      <div className="progress-group-header">
                        <CIcon className="me-2" icon={item.icon} size="lg" />
                        <span>{item.title}</span>
              ...
              <CTable align="middle" className="mb-0 border" hover responsive>
                ...
                <CTableBody>
                  {tableExample.map((item, index) => (
                    <CTableRow v-for="item in tableItems" key={index.toString()}>
